...
BrayDan = [
    ...
    "https://telegra.ph/file/e74503eb4d2851fbc7bcb.jpg",
    "https://telegra.ph/file/e74503eb4d2851fbc7bcb.jpg",
    "https://telegra.ph/file/b300b8b1bf8183907f4fa.jpg",
    "https://telegra.ph/file/b300b8b1bf8183907f4fa.jpg",
    "https://telegra.ph/file/b300b8b1bf8183907f4fa.jpg",
        ...
        if replied.audio or replied.voice:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    ...
                    caption=f"""
**#⃣ تمت إضافة أغنية▪️Position {pos}
🏷️ اسم: {songname}
💬 شات ID: {chat_id}
    ...
    if replied:
        if replied.video or replied.document:
            ...
            if chat_id in QUEUE:
                ...
                # await m.reply_to_message.delete()
                await m.reply_photo(
                    photo="https://telegra.ph/file/b300b8b1bf8183907f4fa.jpg",
                    caption=f"""
**#⃣ وأضاف الفيديو▪️Position {pos}
🏷️ اسم: {songname}
💬 شات ID: {chat_id}
🎬 مطلوبه بواسطة: {m.from_user.mention}**
""",
